...
class AttributeSpec:
    ...
    # ADR-026: an object carries a SET of hazard-relevant subtypes (a ceramic
    # cup of water is BOTH fragile_object AND container). Was a single
    # `subtype`; now `subtypes` so multi-hazard sources instantiate together.
    subtypes: list[PhysicalObjectSubtype] = field(default_factory=list)
...
NAME_KEYWORD_MAP: dict[str, AttributeSpec] = {
    ...
    "杯": AttributeSpec(
        ...
        [PhysicalObjectSubtype.FRAGILE, PhysicalObjectSubtype.CONTAINER],
