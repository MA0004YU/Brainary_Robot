"""Placeholder policy: same brightness heuristic as repair/brain_api_example.SimpleBrain (swap for your planner)."""
...
class BrightnessAvoidancePolicy:
    """Head-camera brightness heuristic -> (vx, vy, yaw_rate, period)."""
