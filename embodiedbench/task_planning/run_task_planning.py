...
From repository root:
  python -m embodiedbench.task_planning.run_task_planning --body sapien --max-ticks 30
  python -m embodiedbench.task_planning.run_task_planning --body repair
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Task planning closed loop (aligned with brain_api_example)"
    )
    parser.add_argument(
        "--body",
