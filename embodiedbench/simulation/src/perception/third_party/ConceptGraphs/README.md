...
# Please clone and install them in separate folders, not within the ConceptGraphs folder. 
...
```bash
git clone git@github.com:ConceptGraphs/ConceptGraphs.git
cd ConceptGraphs
pip install -e .
```
...
export CG_FOLDER=/path/to/ConceptGraphs/
